...
Do not mention the patient's difficulties in any of the phrases nor in the story. The language of the story should be simple and easy to understand. The story should not focus on describing the image, but rather on telling a story that includes the image.

Output the detailed description and story containing all necessary info for the phrases; output those same phrases as well. Make the description brief, while keeping all relevant information. Strictly follow this template:
